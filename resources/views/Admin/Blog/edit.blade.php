            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('update.blog',$model->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="blog_category_id" id="blog_category_id" class="form-select">
                                        ...
                                        <option value="{{$category->id}}" {{ ($model->blog_category_id == $category->id ) ?'selected':'' }}> {{$category->category}} </option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="blog_title" id="blog_title" value="{{$model->blog_title}}" />
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="blog_tags" value="{{$model->blog_tags}}" data-role="tagsinput">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="elm1" name="blog_description">{!! $model->blog_description!!}</textarea>
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img class="rounded avatar-lg" src="{{ !empty($model->blog_image) ? asset('upload/Blog_images/'.$model->blog_image) : asset('upload/no_image.jpg')}}" alt="Blog Image" id="show_image" />
